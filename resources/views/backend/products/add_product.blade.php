          ...
          <div class="container-fluid">
            ...
            Add Product <small><sup><b style="font-size: 20px"></b></sup></small>
              ...
              <div class="card-body">
                ...
                @endforeach --}}
                <form class="" method="post" action="{{route('product.upload')}}">
                    @csrf

                      <div class="form-group">
                        <label>Product Type</label>
                        <select class="form-control text-primary" name="product_type_id">
                        ...
                        @enderror
                        <small class="float-right">Product type not listed here? <a href="{{route('product.add.type')}}">Add new Product Type</a> </small>
                      </div>
                      <div class="form-group">
                        ...
                        <b class="text-danger">{{$message}}</b>
                    @enderror
                        <small class="float-right">Is Brand  not listed here? <a href="{{route('brand.add')}}">Add new Brand</a> </small>
                      </div>
                      {{-- <div class="form-group">
