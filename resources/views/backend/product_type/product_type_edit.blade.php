@include('layouts.backendmaster')
        ...
        <div id="content-wrapper">
          ...
          <div class="mb-3">
            ...
            <form action="{{route('product.type.update', $edit_product_type->id)}}" method="POST">
                @csrf
              <div class="form-group">
                <label for="exampleInputName1">Update Product Type</label>
                <input type="text" class="form-control" id="exampleInputName1" name="update_product_type" value="{{$edit_product_type->product_type}}">
                @error('update_product_type')
                    <span class="text-danger">{{$message}}</span>
                @enderror
              </div>
              <div class="form-group">
                <label for="exampleFormControlTextarea1">Update Product Description</label>
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name="update_product_description">  {{$edit_product_type->product_description}}</textarea>
