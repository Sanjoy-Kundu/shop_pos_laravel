          ...
          <div class="container-fluid">
            ...
            <div class="card mb-3">
              <div class="card-header bg-primary text-white">
                ...
                Product Brands <small><sup><b style="font-size: 20px">{{count($all_brands)}}</b></sup></small>
                <a href="{{route('brand.add')}}" class="text-white">
                        ...
                        <tr>
                            ...
                            <td>
                              <div class="btn-group" role="group" aria-label="Basic example">
                                <button type="button" class="btn btn-danger"><a href="{{url('brand/delete')}}/{{$brand->id}}" class="text-white text-decoration-none">Delete</a></button>
                                <button type="button" class="btn btn-primary"><a href="{{url('brand/edit')}}/{{$brand->id}}" class="text-white" style="text-decoration:none">Edit</a></button>
                              </div>
                            </td>
                          </tr>
                        @empty
                        <tr>
                            <td colspan="6" align="center">Uploaded Your Brand First</td>
                          </tr>
                        @endforelse
                    </tbody>
                  </table>
...
<div class="card mb-3">
    <div class="card-header bg-primary text-white">
      ...
      <a href="" class="text-white">
        <span class="float-right">
          <i class="fa fa-plus"></i>
          Trashed Brand <b class="font-size:30px;"><sup>{{count($all_trashedBrands)}}</sup></b>
        </span>
      </a>
    </div>
    <!-- Button trigger modal -->
    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            @forelse ($all_trashedBrands as $trashedBrand)
            <tr>
                <td>{{$loop->index+1}}</td>
                <td>{{$trashedBrand->brand_name}}</td>
                <td>{{$trashedBrand->brand_description}}</td>
                <td>{{$trashedBrand->deleted_at->format('d-m-Y')}}</td>
                <td>
                    <div class="btn-group" role="group" aria-label="Basic example">
                      <button type="button" class="btn btn-danger"><a href="{{url('brand/permanent/delete')}}/{{$trashedBrand->id}}" class="text-white" style="text-decoration:none">P. Delete</a></button>
                      <button type="button" class="btn btn-primary"><a href="{{url('brand/restore')}}/{{$trashedBrand->id}}" class="text-white" style="text-decoration:none">Restore</a></button>
                    </div>
                  </td>
              </tr>
            @empty
              <tr>
                <td colspan="6" align="center">No Brand Trashted</td>
              </tr>
            @endforelse
